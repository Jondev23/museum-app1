...
export { default as ScreensaverTouchIndicator } from './ScreensaverTouchIndicator';
export { SCREENSAVER_CONFIG, useScreensaverScreenStyles } from './ScreensaverScreenConfig';
